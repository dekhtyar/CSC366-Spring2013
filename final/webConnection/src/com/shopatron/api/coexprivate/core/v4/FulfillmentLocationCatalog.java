 ...
 */
            ...
            /**
            *  FulfillmentLocationCatalog bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FulfillmentLocationCatalog
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = FulfillmentLocationCatalog
                ...
                */
                        ...
                        /**
                        * field for ManufacturerCatalog
                        */

                        
                                    protected com.shopatron.api.coexprivate.core.v4.ManufacturerCatalog localManufacturerCatalog ;
                           ...
                           */
                           public  com.shopatron.api.coexprivate.core.v4.ManufacturerCatalog getManufacturerCatalog(){
                               return localManufacturerCatalog;
                           }
                            ...
                            /**
                               ...
                               * @param param ManufacturerCatalog
                               */
                               public void setManufacturerCatalog(com.shopatron.api.coexprivate.core.v4.ManufacturerCatalog param){
                            
                                            this.localManufacturerCatalog=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FulfillmentLocationCatalog",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (localManufacturerCatalog==null){

                                        writeStartElement(null, "http://v4.core.coexprivate.api.shopatron.com", "ManufacturerCatalog", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localManufacturerCatalog.serialize(new javax.xml.namespace.QName("http://v4.core.coexprivate.api.shopatron.com","ManufacturerCatalog"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://v4.core.coexprivate.api.shopatron.com",
                                    ...
                                    elementList.add(localManufacturerCatalog==null?null:
                                    localManufacturerCatalog);
    ...
    public static class Factory{
        ...
        */
        public static FulfillmentLocationCatalog parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FulfillmentLocationCatalog object =
                new FulfillmentLocationCatalog();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FulfillmentLocationCatalog".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FulfillmentLocationCatalog)com.shopatron.api.coexprivate.core.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://v4.core.coexprivate.api.shopatron.com","ManufacturerCatalog").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setManufacturerCatalog(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setManufacturerCatalog(com.shopatron.api.coexprivate.core.v4.ManufacturerCatalog.Factory.parse(reader));
