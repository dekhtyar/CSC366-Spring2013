...
class CoreServiceServiceLocator:
    CoreService_address = "http://cslvm52.csc.calpoly.edu/inventoryService/"
...
class CoreServiceSoapBindingSOAP:
    ...
    # op: getItemLocationsByFulfiller
    def getItemLocationsByFulfiller(self, request):
        if isinstance(request, getItemLocationsByFulfillerRequest) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(getItemLocationsByFulfillerResponse.typecode)
        return response
...
getItemLocationsByFulfillerRequest = ns0.getItemLocationsByFulfiller_Dec().pyclass

getItemLocationsByFulfillerResponse = ns0.getItemLocationsByFulfillerResponse_Dec().pyclass
