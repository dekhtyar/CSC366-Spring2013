...
<!-- edited with XMLSpy v2013 sp1 (http://www.altova.com) by Dave Cumberland (Shopatron) --><wsdl:definitions targetNamespace=\"http://v4.core.coexprivate.api.shopatron.com\" xmlns:impl=\"http://v4.core.coexprivate.api.shopatron.com\" xmlns:soapenc=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:wsdl=\"http://schemas.xmlsoap.org/wsdl/\" xmlns:wsdlsoap=\"http://schemas.xmlsoap.org/wsdl/soap/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\">
	<wsdl:types>
		<schema elementFormDefault=\"qualified\" targetNamespace=\"http://v4.core.coexprivate.api.shopatron.com\" xmlns=\"http://www.w3.org/2001/XMLSchema\">
			...
			<element name=\"getItemLocationsByFulfillerResponse\">
				<complexType>
					<sequence>
						<element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"getItemLocationsByFulfillerReturn\" type=\"impl:InventorySearchResponse\"/>
					</sequence>
				</complexType>
			</element>
			...
			<element name=\"getBinsResponse\">
				<complexType>
					<sequence>
						<element maxOccurs=\"unbounded\" name=\"getBinsReturn\" type=\"impl:BinResponse\"/>
					</sequence>
				</complexType>
			</element>
			...
			<element name=\"getInventoryResponse\">
				<complexType>
					<sequence>
						<element maxOccurs=\"unbounded\" name=\"getInventoryReturn\" type=\"impl:InventoryResponse\"/>
					</sequence>
				</complexType>
			</element>
			<!-- Models -->
			...
			<complexType name=\"UpdateItem\">
				<sequence>
					...
					<element name=\"FulfillerLocationID\" nillable=\"true\" type=\"xsd:positiveInteger\"/>
				</sequence>
			</complexType>
			...
			<complexType name=\"InventoryRequest\">
				<sequence>
					...
					<element name=\"LocationNames\" nillable=\"true\" type=\"impl:ArrayOfLocationNames\"/>
					<element name=\"Location\" nillable=\"true\" type=\"impl:RequestLocation\"/>
			...
			<complexType name=\"ArrayOfLocationNames\">
				<sequence>
					<element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"LocationNames\" type=\"xsd:string\"/>
				</sequence>
			</complexType>
			<!--Inventory intake-->
			<!-- elements -->
	...
	<wsdl:message name=\"getItemLocationsByFulfillerRequest\">
		<wsdl:part element=\"impl:getItemLocationsByFulfiller\" name=\"parameters\"/>
	</wsdl:message>
	<wsdl:message name=\"getItemLocationsByFulfillerResponse\">
		<wsdl:part element=\"impl:getItemLocationsByFulfillerResponse\" name=\"parameters\"/>
	</wsdl:message>
	...
	<wsdl:portType name=\"CoreService\">
		...
		<wsdl:operation name=\"getItemLocationsByFulfiller\">
			<wsdl:input message=\"impl:getItemLocationsByFulfillerRequest\" name=\"getItemLocationsByFulfillerRequest\"/>
			<wsdl:output message=\"impl:getItemLocationsByFulfillerResponse\" name=\"getItemLocationsByFulfillerResponse\"/>
		</wsdl:operation>
    ...
    def soap_getItemLocationsByFulfiller(self, ps):
        self.request = ps.Parse(getItemLocationsByFulfillerRequest.typecode)
        return getItemLocationsByFulfillerResponse()

    soapAction[''] = 'soap_getItemLocationsByFulfiller'
    root[(getItemLocationsByFulfillerRequest.typecode.nspname,getItemLocationsByFulfillerRequest.typecode.pname)] = 'soap_getItemLocationsByFulfiller'
