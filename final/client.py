...
request.set_element_FulfillerLocationID(600)
...
getBinsReturn = res.get_element_getBinsReturn()[0]
...
for item in items:
    ...
    FulfillerLocationID = item.get_element_FulfillerLocationID()
    BinStatus = item.get_element_BinStatus()
    BinType = item.get_element_BinType()
    Name = item.get_element_Name()
    print 'getBins: Bin:', FulfillerID, FulfillerLocationID, BinStatus, BinType, Name
